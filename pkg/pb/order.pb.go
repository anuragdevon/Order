...
type GetAllOrdersResponse struct {
	...
	Status int64           `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Error  string          `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Data   []*GetOrderData `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *GetAllOrdersResponse) GetData() []*GetOrderData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pkg_pb_order_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x2d, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x6d, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x4f,
	...
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x2e, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x32, 0xe0, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65,
...
var file_pkg_pb_order_proto_depIdxs = []int32{
	...
	2, // 1: order.GetAllOrdersResponse.data:type_name -> order.GetOrderData
